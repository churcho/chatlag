...
$(document).ready(function () {
	...
	var st1 = parseInt(document.getElementById('stats1').innerText)
	var st2 = parseInt(document.getElementById('stats2').innerText)
	var st3 = parseInt(document.getElementById('stats3').innerText)
	var st4 = parseInt(document.getElementById('stats4').innerText)

	var stats = [st1, st2, st3, st4];
	var steps = 20;
	var current_step = 1;
